...
public class GateWaySentinelConfig {
    ...
    public TulingSentinelGatewayBlockExceptionHandler sentinelGatewayBlockExceptionHandler() {
        // Register the block exception handler for Spring Cloud Gateway.
        return new TulingSentinelGatewayBlockExceptionHandler(viewResolvers, serverCodecConfigurer);
    }
